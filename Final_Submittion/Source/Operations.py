...
class Operations:
    ...
    def __init__(self, page: ft.Page, simpage):
        self.file = None
        self.address = 0
    ...
    def IO_op(self, op, address):
        ...
        if address in self.registers:
            ...
            # Write Operation
                ...
                update = ft.FilePickerResultEvent(None,None)
                self.sim_page.output_list.append(self.output)
                self.sim_page.file_picker_result(update)
