...
class Topbar(ft.AppBar):
    def __init__(self, page: ft.Page):
        ...
        self.appbar_items = ft.PopupMenuButton(
            content=ft.Row([
                ft.Icon(ft.icons.PALETTE, color="white"),
    ...
    def custom_theme(self, e):
        def apply_custom_theme(e):
            if not self.is_hex_color(text_color.value):
                ...
                self.page.theme = ft.Theme(
                    color_scheme=ft.ColorScheme(
                        primary=text_color.value,
                        on_primary="0xFFFFFFFF",
                        primary_container=text_color.value,
                        on_primary_container=text_color.value,
        ...
        text_color = ft.TextField(label="Text Color", text_size=10, on_change=textfield_change)
        primary_color = ft.TextField(label="Primary Color", text_size=10, on_change=textfield_change)
        secondary_color = ft.TextField(label="Secondary Color", text_size=10, on_change=textfield_change)
        tertiary_color = ft.TextField(label="Tertiary Color", text_size=10, on_change=textfield_change)
        ...
        #text_color.focus()
        # primary_color.focus()
        # secondary_color.focus()
        # tertiary_color.focus()
